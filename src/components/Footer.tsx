        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="text-gray-300 space-y-2 leading-relaxed">
              ...
              <Link href="/directions" className="inline-block mt-2 text-red-400 hover:text-red-300 transition-colors">
                Get Directions →
              </Link>
            </div>
          </div>
          <div>
            ...
            <div className="text-gray-300 space-y-2">
              <p>
                <Link href="tel:19209069457" className="hover:text-white transition-colors flex items-center">
              ...
              <p>
                <Link href="mailto:info@paneltekllc.com" className="hover:text-white transition-colors flex items-center">
                  <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/careers" className="text-gray-300 hover:text-white transition-colors block">
                JOIN OUR TEAM
              </Link>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <Link href="/privacy-policy" className="text-gray-400 hover:text-white transition-colors mr-4">
                Privacy Policy
              </Link>
              <span className="text-gray-600">|</span>
              <Link href="/sitemap" className="text-gray-400 hover:text-white transition-colors ml-4">
                Sitemap
              </Link>
            </div>
